...
function Img({ src, alt = 'Imagen de la propiedad', className = '', wrapperClassName = '' }: { src?: string, alt?: string, className?: string, wrapperClassName?: string }) {
  const content = !src
    ...
    : <img src={src} alt={alt} className={`avaluo-pdf-img ${className}`} />;
